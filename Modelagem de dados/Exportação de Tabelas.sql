...
CREATE TABLE `SPECIE` (
  ...
  `MEDICINAL_SPECIE` varchar(10) NOT NULL
...
INSERT INTO `SPECIE` (`ID_SPECIE`, `REINO_S`, `FILO_S`, `CLASSE_S`, `ORDEM_S`, `FAMILY_S`, `GENERO_S`, `SPECIE`, `NOME_POPULAR`, `CIDADE_SPECIE`, `PHOTO_1`, `COMMENT`, `DATA_COLETA`, `COLETORES`, `MEDICINAL_SPECIE`) VALUES
...
(3, 'Eric Neves', 'sun469140@gmail.com', 'ed282791c1e8ce2f4ec367f15155e9874db723e1', '', '2023-11-14', '16:28:00'),
(1, 'Thiago Sousa', 'thiagosousa81@gmail.com', '44a5317eae130916886f4408ccae22fb4870e884', 'http://lattes.cnpq.br/4544179861150494', '2023-01-27', '00:40:00'),
...
--
ALTER TABLE `SPECIE`
  MODIFY `ID_SPECIE` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
