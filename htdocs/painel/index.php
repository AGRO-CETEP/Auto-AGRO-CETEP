...
<body style="margin: 0px;padding: 0px;background-image: radial-gradient(white, #fcb900);">
  ...
  <section class="jumbotron container" style="border-radius: 10px; padding-block: 15px; margin-top: 10px;">
    ...
    <ul class="nav nav-tabs">
      ...
      <li class="active"><a data-toggle="tab" href="#home">Perfil <span class="glyphicon glyphicon-user"></span></a>
      </li>
...
">
            <img class="img-circle img-responsive"
              src="https://st.depositphotos.com/1842549/3903/i/600/depositphotos_39038955-stock-photo-user-profile-icon.jpg"
              alt="Foto do perfil" style="width: 100px;height: 100px; margin-inline: auto">
...
">Alterar foto <span class="glyphicon glyphicon-camera"></span></button>
          ...
          <div class="col-sm-10" style="
                                          overflow: auto;
                                          ">
            <h4><span class="glyphicon glyphicon-user"></span> Nome:
              <?php echo ($User[1]); ?>
            </h4>
            <h4><span class="glyphicon glyphicon-envelope"></span> E-mail: <br><a
                href="mailto:<?php echo ($User[2]); ?>">
                <?php echo ($User[2]); ?>
              </a></h4>
            <h4><span class="glyphicon glyphicon-new-window"></span> Currículo Lattes: <br><a
                href="<?php echo ($User[4]); ?>" target="_blank">
                <?php echo ($User[4]); ?>
              </a></h4>
            <h4><span class="glyphicon glyphicon-calendar"></span> Conta criada em:
              ...
              <div id="collapse1" class="collapse">
                <ul class="list-group">
                  <li class="list-group-item">
                    <button class="btn btn-warning well-bg" style="width: 100%;" data-toggle="modal"
                      data-target="#ModalPhoto">
                      <h5 style="margin-block: 0px;">Trocar a senha <span class="glyphicon glyphicon-lock"> </span></h5>
                    </button>
                  </li>
                  <li class="list-group-item">
                    <button class="btn btn-danger well-bg" style="width: 100%;" data-toggle="modal"
                      data-target="#ModalPhoto">
                      <h5 style="margin-block: 0px;">Excluir conta <span class="glyphicon glyphicon-trash"> </span></h5>
                    </button>
                  </li>
                </ul>
              </div>
              ...
              <div class="panel-heading">
                <h4 class="panel-title">
                  <a data-toggle="collapse" href="#collapse2">
                    <h3>Avisos da equipe AGROCETEP</h3>
                  </a>
                </h4>
              </div>
                ...
                <ul class="list-group">
                  <li class="list-group-item" style="overflow: auto; max-height: 200px;">
                    <p style="
                      ...
                      É um prazer para nós ter a você como um colaborador de conteúdo em nosso sistema de
                      informação!<br>
                      Atualmente nosso sistema de informação está em desenvolvimento. Estamos trabalhando para
                      concluí-lo o mais breve possível.<br>
                      <br> Caso tenha dificuldade com algo na nossa plataforma entre em contato com o e-mail <a
                        href="mailto:thiagosousa81@gmail.com">thiagosousa81@gmail.com</a>
                    </p>
                  </li>
                </ul>
              </div>
      ...
      <div id="catalog" class="tab-pane fade">
        ...
        <form method="POST" action="upload.php" class="row" enctype="multipart/form-data">
          ...
          <div class="col-sm-4">
            ...
            <a href="#" target="_blank" id="imagemLink"><img id="imagemPreview" src="#" alt="Prévia da Imagem"
                style="display: none; max-width: 300px; max-height: 300px; margin-top: 10px; margin-inline: auto"></a>
          </div>
...
/*
            // Função para exibir a prévia da imagem selecionada
            function exibirPreviewImagem2(input) {
              var imagemPreview2 = document.getElementById('imagemPreview2');
              var imagemLink2 = document.getElementById('imagemLink2');
              if (input.files && input.files[0]) {
                var reader = new FileReader();

                reader.onload = function (e) {
                  imagemPreview2.style.display = 'block';
                  imagemPreview2.src = e.target.result;
                  imagemLink2.href = e.target.result;
                };

                reader.readAsDataURL(input.files[0]);

              } else {
                imagemPreview2.style.display = 'none';
                imagemLink2.style.display = 'none';
                imagemPreview2.src = '';
                imagemLink2.href = '#'; // Define o href como "#" para não redirecionar em caso de ausência de imagem
              }
            }

            // Vincule a função ao evento onchange do input de imagem
            document.getElementById('imagemInput2').addEventListener('change', function () {
              exibirPreviewImagem2(this);
            });

            document.getElementById('imagemLink2').addEventListener('click', function (event) {
              event.preventDefault(); // Evita que o link seja aberto na aba atual
              var url2 = 'https://agrocetep.epizy.com/painel/img2'; // Substitua com a URL desejada
...
<!--
          ...
          <div class="col-sm-4">
            <label for="imagem">Foto do medicamento:</label>
            <input type="file" name="imagem2" id="imagemInput2">
            <a href="#" target="_blank" id="imagemLink2"><img id="imagemPreview2" src="#" alt="Prévia da Imagem 2"
                style="display: none; max-width: 300px; max-height: 300px; margin-top: 10px; margin-inline: auto"></a>
          </div>
          <div class="col-sm-4">
            <label class="form-label">Descrição do medicamento:</label>
            <textarea class="form-control" id="txtdescricao" name="txtDescricao" rows="5"></textarea>
          </div>-->

          <div class="text-center col-sm-4">
            <button type="submit" class="btn btn-success"
              style="width: 100%; margin-block: 20px"><b>CADASTRAR</b></button>
          </div>
      ...
      <div id="info" class="tab-pane fade">
        ...
        <hr style="margin-block-start: 10px; border: 0; border-top: 3px solid black;">
        <p style="text-align: justify"><strong>AGROCETEP</strong> é o nome que foi dado ao projeto de catalogagem online
          do levantamento florístico do CETEP Alberto Torres. <br></p>
        <div class="row">


          <div class="col-sm-5">
            <img class="img-responsive"
              src="https://agrocetep.files.wordpress.com/2022/08/whatsapp-image-2022-08-15-at-08.00.43.jpeg" alt=""
              style="
                                                                                                                                                      max-width: 300px;
                                                                                                                                                      margin-inline: auto;
                                                                                                                                                      ">
          ...
          <div class="col-sm-7" style="
                                         ">
            <img class="img-responsive" src="https://agrocetep.files.wordpress.com/2022/07/cruz-news.jpg" alt=""
              style="
                                                                                                                          max-width: 100%;
                                                                                                                          margin-inline: auto;
                                                                                                                          margin-block: auto;
        ...
        <p style="text-align: justify; margin-top: 10px">
          Atualmente estamos iniciando a automação do catálogo para que qualquer pesquisador posa inserir e alterar
          informações, contribuíndo para uma melhor identificação das espécies.
        </p>
      </div>
    </div>
  </section>
  ...
  <footer class="container-fluid p-5 bg-secondary text-white" style="
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        ...
        <p>Sistema protegido por <a href="http://ebs-systems.epizy.com/" target="_blank" style="color: white">EBS
