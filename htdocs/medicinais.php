...
<html lang="pt-br">
  ...
  <head>
    ...
    <title>AGROCETEP - Plantas Medicinais</title>
  ...
  <body style="margin: 0px;padding: 0px;background-image: radial-gradient(white, #fcb900);">
    ...
    <section class="jumbotron container" style="border-radius: 10px; padding-block: 15px; margin-top: 10px;">
      ...
      <ul class="nav nav-tabs">
        ...
        <li class=""><a data-toggle=""href="/">Todas as espécies <span class="glyphicon glyphicon-leaf"></span></a></li>

        <!--        <li class="active"><a href="#home">Perfil <span class="glyphicon glyphicon-user"></span></a></li>        -->

        <li class="active"><a data-toggle="tab" href="/medicinais.php" aria-expanded="false">Espécies medicinais <span class="glyphicon glyphicon-plus"></span></a></li>
      ...
      <div class="tab-content jumbotron">
        ...
        <div id="all" class="tab-pane fade in active"> 
          ...
          <p>As espécies desta página foram coletadas na comunidade de Lagoa de Cedro em Cruz das Almas-Ba. <br>Essa pesquisa faz parte do produto de dissertação da professora Rubenilza Dias.</p>

          <?php 

$query = mysqli_query($link, "SELECT * FROM `SPECIE` WHERE `MEDICINAL_SPECIE`='on'");
...
while($rows = mysqli_fetch_array($query)) {
    ...
    <div class="row" style="display: flex;">
        ...
        <div class="col-sm-2 plant" style="overflow: hidden; padding-inline: auto; text-align: center">                         
            ...
            <div style="margin-inline: auto;width: 80%;overflow: visible;height: 100px;display: flex;justify-content: center;align-items: center;">

                <a data-toggle="modal" href="#ModalPhoto<?= $rows[0] ?>">

                    <img class="img-responsive" src="https://agrocetep.epizy.com/images/plants/<?= base64_decode($rows[10]) ?>" alt="Foto da planta" style="/*max-height: 200px;max-width: 200px;min-width: 200px;min-height: 200px; */ width: 100%; margin-inline: auto">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content" style="size: 90%">
            ...
            <div class="modal-footer">
                ...
                <a href="https://agrocetep.epizy.com/especie.php?id=<?=$rows[0] ?>" target="_blank">
